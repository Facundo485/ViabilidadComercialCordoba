...
REGLAS: list[Regla] = [
    ...
    (
        "bijouterie",
        INDUM,
        r"bijouterie|fantasia|plateria|alhajas|orfebreria|joyeria|relojeria|\bjoyas\b|\brelojes\b",
        "",
    ),
    ...
    (
        "farmacia",
        SALUD,
        r"farmacia|productos farmaceuticos|medicamentos de uso humano",
        r"veterinari|asesoramiento",
    ),
    ...
    (
        "consultorio",
        SALUD,
        r"atencion ambulatoria|consultorio|servicios medicos|salud humana|"
        r"servicios de tratamiento|odontolog|kinesiolog|psicolog",
        "",
    ),
    ...
    (
        "electrodomesticos",
        HOGAR,
        r"electrodomesticos|artefactos para el hogar|aparatos de uso domestico",
        "",
    ),
    (
        "articulos_hogar",
        HOGAR,
        r"articulos del hogar|articulos para el hogar|decoracion|blanco\b|cortinas|alfombras",
        "",
    ),
    ...
    (
        "taller_mecanico",
        AUTO,
        r"reparacion de automotores|mecanica integral|taller|chapa y pintura|\blubricentro\b",
        "",
    ),
    (
        "venta_vehiculos",
        AUTO,
        r"venta de automotores|concesionari|\bmotocicletas\b|bicicleteria|\bbicicletas\b",
        "",
    ),
    (
        "estacion_servicio",
        AUTO,
        r"estacion de servicio|expendio de combustible|\bgnc\b|"
        r"playa de estacionamiento|lavadero de auto",
        "",
    ),
    ...
    (
        "inmobiliaria",
        SERVPR,
        r"inmobiliari|locacion de bienes inmuebles|administracion, alquiler",
        "",
    ),
    (
        "oficina",
        SERVPR,
        r"oficina administrativa|gestion administrativa|servicios empresariales|"
        r"\bestudio\b|desarrollo de software|servicios prestados a las empresas|"
        r"profesionales organizados",
        "",
    ),
    (
        "cobranzas",
        SERVPR,
        r"cobranzas|agencias de cobro|crediticia|\bfinanciera\b|\bcambio\b|prestamos|\bbancos?\b",
        "",
    ),
    ...
    (
        "transporte",
        SERVPR,
        r"transporte|\bremis\b|\bmensajeria\b|\bflete\b|\bdelivery\b|reparto a domicilio",
        "",
    ),
    # --- Esparcimiento
    ...
    (
        "educacion",
        EDU,
        r"\bensenanza\b|\binstituto\b|\bcolegio\b|\bjardin de infantes\b|"
        r"\bguarderia\b|\bcapacitacion\b",
        "",
    ),
    ...
    (
        "tecnologia",
        GENERAL,
        r"telefonia|celulares|computacion|informatic|perifericos|\belectronica\b",
        "",
    ),
    ...
    (
        "comercio_otros",
        GENERAL,
        r"articulos nuevos|articulos varios|no especializados|otras actividades",
        "",
    ),
]
